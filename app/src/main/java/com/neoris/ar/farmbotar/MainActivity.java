...
import com.neoris.ar.farmbotar.util.SampleCategory;
import com.wikitude.architect.ArchitectView;
import com.wikitude.common.permission.PermissionManager;
import com.wikitude.common.util.SDKBuildInformation;
import com.neoris.ar.farmbotar.util.PermissionUtil;
import com.neoris.ar.farmbotar.util.SampleData;
import com.neoris.ar.farmbotar.util.SampleJsonParser;
import com.neoris.ar.farmbotar.util.adapters.SamplesExpendableListAdapter;
import com.neoris.ar.farmbotar.util.urllauncher.UrlLauncherStorageActivity;
...
public class MainActivity extends AppCompatActivity implements ExpandableListView.OnChildClickListener {
    ...
    private static final String sampleDefinitionsPath = "exper/farmbot.json";
    ...
    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
        ...
        permissionManager.checkPermissions(MainActivity.this, permissions, PermissionManager.WIKITUDE_PERMISSION_REQUEST, new PermissionManager.PermissionManagerCallback() {
            ...
            public void permissionsGranted(int requestCode) {
                ...
                intent.putExtra(ScanActivity.INTENT_EXTRAS_KEY_SAMPLE, sampleData);
